...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <img src="{{ asset('assets/images/logo.png') }}" alt="logo.png" width="40" height="40" class="d-inline-block align-text-top me-2">
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="display-6 mb-2 font-custom" ><h1> {{ $username }} </h1>
                                    <p> {{ $last_login }} </p>
